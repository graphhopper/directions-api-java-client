...
public class GoogleMatrixSyncRequesterTest {
    ...
    public void testMatrix() throws IOException {
        ...
        GraphHopperMatrixWeb matrix = createMatrixClient(AbstractGHMatrixWebTester.readFile(new InputStreamReader(getClass().getResourceAsStream("google-matrix1.json"))));
